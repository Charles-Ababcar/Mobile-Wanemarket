...
class ApplicationState {
  ...
  Future<void> init() async {
    ...
    this.cguValidated = await prefs.getString("wanemarket_cgu") != null;
    print("applications state has init data phone: '${this.phone}' '${this.authToken}'");
    print("CGU Validated: ${this.cguValidated}");
  }
  ...
  Future<void> validatedCGU() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setString("wanemarket_cgu", "true");
