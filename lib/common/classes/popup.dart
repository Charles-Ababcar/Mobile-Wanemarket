...
class Popup {
  ...
  static confirmOpenWhatsApp(context, mess) {
    return new AlertDialog(
        backgroundColor: yellowLight,
        title: Text("Ouvrir WhatsApp ?"),
        content: Column(
            mainAxisSize: MainAxisSize.min,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              ...
              Center(
                  child: RoundButton(
                icon: Icon(MyIcons.whatsapp, color: Colors.white),
                width: 50,
                height: 50,
  ...
  static confirmDeconnection(context, mess) {
    return new AlertDialog(
        ...
        content: Column(
            ...
            children: [
              Text(
                "Toute modifications non enregistrée sera perdue",
                style: TextStyle(fontSize: 13),
              ),
              SizedBox(height: sizedBoxHeight),
              Center(
  ...
  static confirmMarketplaceDecision(context, decision, callback) {
    return new AlertDialog(
        backgroundColor: yellowLight,
        title:
            Text(decision ? "Valider cet annonceur" : "Refuser cet annonceur"),
        content: Column(
            mainAxisSize: MainAxisSize.min,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
  ...
  static confirmLekket(context, clientCallback) {
    return new AlertDialog(
        ...
        content: ConfirmLekketWidget(
          callback: (int quantity, String shoeSize, String clotheSize,
              String color, String? descr) {
