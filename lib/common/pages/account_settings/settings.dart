...
*/
  ...
  Widget mainPage(User user, Size size) {
    return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      ...
      /**
           * marketplace card
           */
      isMarketplaceValidated(user)
          ? marketplaceCard(user, size)
          : new Container(),
      SizedBox(height: 10),
      ...
      /**
           ...
           */
      (isMarketplaceValidated(user)
          ? sellerSpaceButton(context)
          : new Container()),
      (isMarketplaceValidated(user)
          ? moneyAcountButton(context)
          : new Container()),
  ...
  ActionButton whatsAppButton(BuildContext context) {
    return ActionButton(
        ...
        icon: const Icon(MyIcons.whatsapp, color: Colors.white, size: 30),
        iconBackgroundColor: lightGreen,
        mainColor: lightGreen,
        borderColor: lightGreen, //Color(0xFFc2e9fb),
        text: Text("Service client (76 345 33 62)",
            style: TextStyle(fontSize: 15)),
        callback: () {
  ...
  whatsapp() async {
    var contact = "+33647101319";
    var androidUrl =
        "whatsapp://send?phone=$contact&text=Bonjour Wanémarket, Je vous contacte depuis l'application mobile afin de ...";
    var iosUrl =
        "https://wa.me/$contact?text=${Uri.parse("Bonjour Wanémarket, Je vous contacte depuis l'application mobile afin de ...")}";
