...
class _LoginWidget extends State<LoginWidget> {
      ...
      child: Container(
        child: Column(
          ...
          children: <Widget>[
             ...
             * wanemarket logo
             */
            Image.asset("images/wanemarket_logo.png", height: size.height * 0.15),
  ...
  Widget sendingButton() {
    return MainButton(buttonText: "Connexion", onPressed: () async {
  ...
  forgotPassword() {
    return GestureDetector(
      onTap: () {
        print("ok");
        showDialog(context: context, builder: (context) => Popup.confirmOpenWhatsApp(context, "Contactez le service client sur WhatsApp\n(76 345 33 62) pour retrouver votre mot de passe."));
        //OpenWhatsapp();
      },
      child: Padding(
