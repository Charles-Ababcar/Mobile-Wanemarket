...
import 'package:mobile_frontend/common/customed-widgets/page-title.dart';
...
class HomePageVisitor extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _HomePageVisitor();

}

class _HomePageVisitor extends State<HomePageVisitor> {
    ...
    return Expanded (
      child: ListView(
          ...
          children: categories.map<Widget> ((category) {
            return new ItemContainer(category);
          }).toList()
      ),
    );
  }
