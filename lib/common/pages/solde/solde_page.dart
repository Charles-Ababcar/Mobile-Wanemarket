...
class _SoldePage extends State<SoldePage> {
  ...
  getOrderButton(context) {
    return BigButton(
      ...
      callback: () {
        showDialog(context: context, builder: (context) => getVirementRequestDialog());
  ...
  getVirementRequestDialog() {
    return AlertDialog(
        backgroundColor: yellowLight,
        title: Text("Demande de retrait par virement"),
        content: VirementRequestModal(
          afterRequest: () {
            soldeBloc.loadUserSolde();
            Navigator.of(context).pop();
          },
